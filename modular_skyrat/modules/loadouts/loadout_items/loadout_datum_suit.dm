...
/datum/loadout_item/suit/navybluejacketofficer
	...
	restricted_roles = list(JOB_SECURITY_OFFICER, JOB_HEAD_OF_SECURITY, JOB_WARDEN, JOB_CORRECTIONS_OFFICER) // I aint making a medic one, maybe i'll add some rank thing from cm or civ for it
